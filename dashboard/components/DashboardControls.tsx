...
export const MobileControls: React.FC<DashboardControlsProps> = ({ 
  ...
  onOpenConfig, onOpenHistory, onOpenHelp 
}) => {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-[75px] left-0 right-0 z-[450] px-4 pointer-events-none flex justify-between items-start">
        {/* Mode Pill */}
      ...
      {mobileTab === 'preview' && (
        <div className="lg:hidden fixed top-[135px] left-1/2 -translate-x-1/2 z-[440] pointer-events-none">
